...
El uso del Gestor de DDoS requiere una IP dedicada o la opción adicional "Visión general del Gestor de DDoS". Si tu paquete actual no incluye estos componentes, puedes añadirlos en cualquier momento actualizando tu servicio.
:::
...
:::warning
El uso del Gestor de DDoS solo es posible si tienes una IP propia o la opción adicional "Visión general del Gestor de DDoS". Si estos componentes faltan en tu paquete actual, puedes añadirlos en cualquier momento actualizando.
:::
...
En esta sección encontrarás un historial de interrupciones del sistema anfitrión donde corre tu servidor de juego. Más información y la versión más reciente del estado de nuestros servicios la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
En **Versiones** puedes ver y gestionar la versión actual de tu servidor de juego. Aquí puedes actualizar a la última versión en cualquier momento o activar las actualizaciones automáticas para que tu servidor esté siempre al día.
...
Crea tareas programadas que se ejecutan automáticamente en horarios definidos para automatizar procesos en tu servidor. Puedes configurar si una tarea se ejecuta una vez o se repite según necesites. Los tipos de tareas soportadas incluyen iniciar, detener o reiniciar servicios, reiniciar el servidor si está online, crear backups o ejecutar comandos personalizados.

![](https://screensaver01.zap-hosting.com/index.php/s/P6DeWiRC3tDqG2z/preview)

### Planificador de reinicios

¿Quieres programar reinicios del servidor en horarios específicos? El Planificador de reinicios te permite configurar reinicios automáticos programados de tu servidor de juego. Con esta función puedes establecer reinicios en horarios concretos o a intervalos regulares.
...
En la sección de **Herramientas** de tu panel de navegación encontrarás varios subapartados que te ayudarán a gestionar tu servidor. Estos incluyen **Explorador FTP**, **Bases de datos** y **Backups**. A continuación te damos una introducción detallada a estas áreas.
...
Además de nuestros productos de servidores de juego, ofrecemos 10 bases de datos incluidas. Estas bases de datos son necesarias, por ejemplo, cuando se deben almacenar datos en una base. En **Bases de datos** puedes crear una base y ver las credenciales de acceso. También puedes activar la opción de backup e importar copias de seguridad existentes.
...
En **Backups** tienes la opción de crear copias de seguridad manuales y automáticas para tu servidor y su base de datos asociada. Esto facilita recuperar tus datos en caso de problemas o pérdida.
...
Ofrecemos documentación extensa para nuestros productos, que sirve como base de conocimiento para las preguntas y dudas más frecuentes. Allí encontrarás guías y ayudas sobre diferentes temas que te asistirán en el uso y gestión de tu producto.
...
Revisando las **Noticias** regularmente estarás al día y podrás ajustar tu servicio para sacar el máximo provecho de tu servidor. Test news.
